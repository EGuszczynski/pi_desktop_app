...
namespace DesktopDataGrabber.ViewModel
{
    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public MainViewModel()
        {
            ...
            ENVChart_press = new PlotModel { Title = "Pressure" };
            ENVChart_humid = new PlotModel { Title = "Humidity" };
            ...
            ENVChart_temp.Series.Add(new LineSeries() { Title = "temperature", Color = OxyColor.Parse("#FFFF0000") });
            ENVChart_press.Series.Add(new LineSeries() { Title = "pressure", Color = OxyColor.Parse("#0000FF") });
            ENVChart_humid.Series.Add(new LineSeries() { Title = "humidity", Color = OxyColor.Parse("#ffff00") });
